...
public class Server {
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            outFile.format("Server utilization %16.3f minutes\n", area_server_status / sim_time);
            outFile.format("Time simulation ended  %16.3f minutes\n", sim_time);
	...
	{   DecimalFormat dformat= new DecimalFormat("#.###"); 
		...
		System.out.println( "Mean interarrival time " + dformat.format(mean_interarrival) + " minutes" + "\n");
		System.out.println( "Mean service time  " + dformat.format(mean_service) + " minutes"  + "\n");
		System.out.println( "Number of customers  " + dformat.format(num_delays_required) + " minutes"  + "\n");
		System.out.println( "Server utilization  " + dformat.format(area_server_status / sim_time) + " minutes" + "\n");
